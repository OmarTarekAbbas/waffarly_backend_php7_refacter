...
<head>
    ...
    <title>
        ...
        $categories = Helper::Du_standards($request) ;
    ...
    <div id="main">
        <div id="slide-out-right" class="side-nav">
            <ul class="collapsible" data-collapsible="accordion">
                ...
                @else
                <li><a href="{{url(Du_Bundle_Route)}}"><i class="fa fa-dashboard"></i> الرئيسية</a></li>
                @endif
                @if(Session::has('MSISDN_ETISALAT'))
                <li class=""><a href="#0"><i class="fa fa-user"></i>{{session('MSISDN_ETISALAT')}}</a></li>
                @endif
                <li>
                    <a class="collapsible-header active"><i class="fa fa-shopping-bag"></i> التصنيفات <span
                        ...
                        <ul>
                            ...
                            <li><a
                                    href="{{url(Du_Bundle_Route.'/get_category?category_id='.$category->id)}}">{{$category->category_name}}</a>
                            </li>
                            @endforeach
                            @endif
                        </ul>
                ...
                <li><a href="{{url(Du_Bundle_Route.'/terms')}}"><i class="fa fa-edit"></i> الارشادات</a></li>
                @if (Session::has('MSISDN') && Session::get('Status') == 'active')
                <li><a href="{{url('du_logout_web')}}"><i class="fa fa-sign-out"></i> خروج</a></li>
                @else
                <li><a href="{{url('/du_landing')}}"><i class="fa fa-sign-in"></i> دخول</a></li>
                @endif
            </ul>
        </div>
