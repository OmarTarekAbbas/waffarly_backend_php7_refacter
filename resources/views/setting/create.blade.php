            ...
            <div class="box">
                ...
                <div class="box-content">
                    ...
                    <form action="{{url('setting')}}" method="post"
                        ...
                        <div class="form-group" hidden id="input_color">
                            <label class="col-sm-3 col-lg-2 control-label">Color *</label>
                            <div class="col-sm-9 col-lg-10 controls">
                                <input type="color" name="input_color" value="#000000" style="width: 100%">
                            </div>
                        </div>
