...
<div class="row">
    <div class="col-md-12">
        <div class="box">
            <div class="box-title">
                <h3><i class="fa fa-bars"></i>Add Brand Form</h3>
                <div class="box-tool">
            ...
            <div class="box-content">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-lg-10 controls">
                        {!! Form::text('brand_name',null,['placeholder'=>'Brand Name','class'=>'form-control input-lg','required' => 'required']) !!}
                        ...
                        <div class="fileupload fileupload-new" data-provides="fileupload">
                            ...
                            <div>
                                <span class="btn btn-default btn-file"><span class="fileupload-new">Select image</span>
                                    ...
                                    {!! Form::file('image',['required'=>'required']) !!}</span>
